      ...
      <div className="border py-3 px-6">
        <div className="flex justify-between">
          <div className="flex items-center">
            ...
            <span className="ml-2 font-semibold text-[#252C32]">A-Market</span>
          </div>
          ...
          <div className="ml-2 flex">
            ...
            <a
                ...
                >
                  <span className="text-sm font-medium" >Sign in</span> </a> 
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="flex cursor-pointer select-none items-center gap-x-2 rounded-md border bg-[#ffb190] py-2 px-4 text-white hover:bg-blue-500">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="none"
