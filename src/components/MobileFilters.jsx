...
export function MobileFilters({ mobileFiltersOpen, setMobileFiltersOpen, subCategories, filters }) {
  return (
    <Dialog open={mobileFiltersOpen} onClose={setMobileFiltersOpen} className="relative z-40 lg:hidden">
      ...
      <div className="fixed inset-0 z-40 flex">
        <DialogPanel
          transition
          className="relative ml-auto flex h-full max-w-xs transform flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl transition duration-300 ease-in-out data-closed:translate-x-full"
        >
                        ...
                        <div className="flex h-5 shrink-0 items-center">
                          <div className="group grid h-4 w-4 grid-cols-1">
                            ...
                            <svg
                              fill="none"
                              viewBox="0 0 14 14"
                              className="pointer-events-none col-start-1 row-start-1 h-3.5 w-3.5 self-center justify-self-center stroke-white group-has-checked:opacity-100 opacity-0"
                            >
                              <path
                                d="M3 8L6 11L11 3.5"
                                strokeWidth={2}
